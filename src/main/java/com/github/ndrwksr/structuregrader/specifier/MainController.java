...
public class MainController implements Initializable {
	...
	/**
	 * The TreeView for previewing the scanned project's structure.
	 */
	@FXML
	public TreeView<String> projectTree;

	/**
	 * The TreeView for seeing the generated specification stack.
	 */
	@FXML
	public TreeView<String> specificationTree;

	/**
	 * The TextArea for displaying the description for the highlighted specification.
	 */
	@FXML
	public TextArea descriptionTextArea;

	/**
	 * The TextField used to specify the package to scan from the loaded .jar.
	 */
	@FXML
	public TextField pkgToScanField;

	/**
	 * The Label the displays the path to the .jar that has been loaded.
	 */
	@FXML
	public Label loadedJarLabel;

	/**
	 * The Button which scans the package specified by pkgToScanField.
	 */
	@FXML
	public Button scanPackageButton;

	/**
	 * The TextArea at the bottom of the main window which displays the application log.
	 */
	@FXML
	public TextArea logTextArea;

	/**
	 * The Button which removes the highlighted specification from the stack.
	 */
	@FXML
	public Button removeSpecButton;

	/**
	 * The Button which clears the scanned package.
	 */
	@FXML
	public Button clearPackageButton;

	/**
	 * The Button which passes the scanned package into the core for specification.
	 */
	@FXML
	public Button specifyPackageButton;

	/**
	 * The Button which opens a dialog to save the generated specification stack as a .spec file.
	 */
	@FXML
	public Button exportButton;

	/**
	 * The Button which clears out the specification stack.
	 */
	@FXML
	 ...
	 */
	private final SimpleObjectProperty<URLClassLoader> urlClassLoaderSop = new SimpleObjectProperty<>(null);

	/**
	 * Property for the name of the package within the jar to scan.
	 */
	private final SimpleStringProperty pkgToScanSsp = new SimpleStringProperty(null);

	/**
	 * Property for the ClassMap generated by scanning the loaded jar.
	 */
	private final SimpleObjectProperty<ClassMap> classMapSop = new SimpleObjectProperty<>(null);
	/**
	 * Property for the ClassMapSuite generated by specifying the ClassMap.
	 */
	private final SimpleObjectProperty<ClassMapSuite> classMapSuiteSop = new SimpleObjectProperty<>(null);
	 ...
	 */
	private TreeItem<String> treeItemFromClass(final ClassWrapper clazz) {
	...
	private static class SpecTreeItem extends TreeItem<String> implements Removable {
		...
		public void setRemove(Runnable remove) {
			this.remove = remove;
		}
	}
